"""
Startup Script for YouTube Video Analysis Backend
...
def main():
    ...
    parser = argparse.ArgumentParser(description='YouTube Video Analysis Backend Server')
    parser.add_argument('--frontend', action='store_true', help='Start both frontend and backend servers')
    ...
    if args.frontend:
        # Start all servers
        start_all_servers()
    elif args.backend_only or not args.frontend:
        # Start only backend
